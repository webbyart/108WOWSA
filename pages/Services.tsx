    ...
    <div className="py-12 bg-brand-dark min-h-screen">
      <div className="container mx-auto px-4">
        ...
        <div className="text-sm text-gray-500 mb-8">
          ...
          <Link to="/services" className="hover:text-brand-lime"> {labels.services}</Link> 
        ...
        {!isSpecific ? (
          ...
          <div>
            <h1 className="text-4xl font-bold text-center mb-8 text-brand-lime">{labels.services}</h1>
  ...
  return (
    <div className={`flex flex-col md:flex-row gap-8 items-center ${reverse ? 'md:flex-row-reverse' : ''}`}>
      <div className="w-full md:w-1/2 h-[300px]">
        <EditableImage id={imgId} defaultSrc="https://picsum.photos/600/400" alt={title} className="w-full h-full rounded-xl shadow-md border border-gray-700" />
      </div>

  ...
  return (
    <div className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center mb-12 text-brand-blue">ติดต่อเรา (Get in Touch)</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <EditableText id="contact_address" defaultText="บริษัท 108WOW จำกัด xxx ถนน xxx แขวง xxx เขต xxx กรุงเทพฯ" />
                </div>
              </div>
              <div className="flex items-start gap-4">
          ...
          <div className="bg-white p-8 rounded-xl shadow-xl border border-gray-100">
            ...
            <form className="space-y-4">
              ...
              <div>
                 <label className="block text-sm font-medium text-gray-700 mb-1">ประเภทงานที่สนใจ</label>
